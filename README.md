...
When dual booting with Windows, it is usually better to:
- Disabe fast boot and secure boot in BIOS menu. You can often access this menu by pressing a key while your PC is booting, such as F1, F2, F12, or Esc.
